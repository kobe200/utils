 ...
 * @decribe:
 */
public class CopyThread2 extends BaseThread {
    private final String tag = CopyThread2.class.getSimpleName();
    /**
     * 是否取消当前工作
     */
    ...
    public CopyThread2(List<File> copyFiles,String[] logFilePath,String usbPath) {
        super();
     ...
     * @return
     */
    private boolean copyFile(File oldFile,String newFilePath) {
        boolean isCopySuccess = true;
        try {
            String command = "cp " + oldFile.getPath() + " " + newFilePath;
            Log.i(tag,"===copyFile====" + command);
